    ...
    <div className='max-w-[1200px] mx-auto bg-black sm:py-20 p-5' id="contact">
        ...
        <div className='max-w-[800px] mx-auto'>
            ...
            <div className='mt-6 bg-[#161616] rounded-xl'>
                <div className='p-10'>
                    <form action="https://getform.io/f/awnnzxkb" method="POST">
                            <div className='grid grid-cols-1 sm:grid-cols-2 gap-x-5 gap-y-4'>
                                <div>
                                    <div className='mt-2.5 relative'>
                                        <input type="text" name="name" id="" placeholder='Your Name'
                                            className='bg-[#161616] w-full px-4 py-4 text-gray-400 placeholder-gray-400 border 
                                            border-gray-700 rounded-md focus:outline-none focus:border-violet-500'/>
                                    </div>
                                </div>
                                ...
                                <div className='sm:col-span-2'>
                                    <div className='mt-2.5 relative'>
                                        <textarea type="text" name="message" id="" placeholder='Your Message'
                                            className='bg-[#161616] w-full px-4 py-4 text-gray-400 placeholder-gray-400 border 
                                            border-gray-700 rounded-md focus:outline-none focus:border-violet-500' rows="5"/>
                                    </div>
                                </div>
